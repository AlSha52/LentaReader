...
import com.foxykeep.datadroid.internal.network.NetworkConnectionImplF;
...
public final class NetworkConnection {
     ...
     * @return The result of the webservice call.
     */
    public ConnectionResult execute(File file) throws ConnectionException {
        return NetworkConnectionImplF.execute(mContext, mUrl, mMethod, mParameterList,
                mHeaderMap, mIsGzipEnabled, mUserAgent, mPostText, mCredentials,
                mIsSslValidationEnabled, file);
    }
}
